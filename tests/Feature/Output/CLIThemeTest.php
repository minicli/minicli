...
it('asserts that Dracula CLI theme sets all default styles', function () {
...
it('asserts that missing styles in Dracula CLI theme are included from default theme', function () {
    $theme = new DraculaTheme();
